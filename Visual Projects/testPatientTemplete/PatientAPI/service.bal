...
service / on new http:Listener(9090) {
    ...
    resource isolated function get fhir/r4/Patient(http:RequestContext ctx, http:Request request) returns json|xml|r4:FHIRError|error {

        r4:FHIRContext ftx = check r4:getFHIRContext(ctx);
        r4:FHIRSecurity fhSecurity = <r4:FHIRSecurity>ftx.getFHIRSecurity();
        log:printDebug(fhSecurity.toBalString());
